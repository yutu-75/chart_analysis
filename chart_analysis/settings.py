"""
Django settings for chart_analysis project.
...
sys.path.insert(0, os.path.join(BASE_DIR, r"chart_analysis/apps"))
...
WSGI_APPLICATION = 'chart_analysis.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {  # 日志处理方式，日志实例
        ...
        'file': {
            ...
            'filename': Path(BASE_DIR, "logs/analysis.log"),  # 注意，你的文件应该有读写权限。
            # 日志文件的最大值,这里我们设置300M
